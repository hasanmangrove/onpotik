...
<html>
    <head>
        <title>Onpotik - Tentang Kami</title>
        <!-- for-mobile-apps -->
                    ...
                    <div class="col-md-8 about-wthree-grids grid-top">
                        ...
                        <div class="about-w3agilerow">
                            <div class="col-md-4 about-w3imgs">
                                <img src="<?= base_url('assets'); ?>/images/p3.jpg" alt="" class="img-responsive zoom-img"/>
                            </div>
                            <div class="col-md-4 about-w3imgs">
                                <img src="<?= base_url('assets'); ?>/images/p4.jpg" alt=""  class="img-responsive zoom-img"/>
                            </div>
                            <div class="col-md-4 about-w3imgs">
                                <img src="<?= base_url('assets'); ?>/images/p3.jpg" alt=""  class="img-responsive zoom-img"/>
                            </div>
