            ...
            <div class="container">
                <div class="col-md-4 products-left">
                    <div class="categories">
                        <h2>Kategori</h2>
                        <ul class="cate">
                            <li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>Obat</a></li>
                            <li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>Alat Kesehatan</a></li>
                            <li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>Suplemen dan Vitamin</a></li>
                        </ul>
                    </div>																																												
                </div>
