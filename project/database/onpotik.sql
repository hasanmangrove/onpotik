...
INSERT INTO `produk` VALUES (1,'PARACETAMOL KIMIA FARMA 500MG',1833,500,'obat','Sakit kepala , sakit gigi , demam , nyeri haid , sakit pada otot , obat generik','PARACETAMOL KIMIA FARMA 500MG merupakan sediaan tablet yang didistribusikan oleh PT. Kimia Farma. Paracetamol merupakan salah satu obat yang masuk ke dalam golongan analgesik (pereda nyeri) dan antipiretik (penurun demam). Obat ini dipakai untuk meredakan rasa sakit ringan hingga menengah seperti sakit kepala, sakit gigi dan, mialgia serta menurunkan demam. ',NULL,NULL,NULL),(2,'OBH COMBI BATUK BERDAHAK RASA MINT 100ML',11666,50,'obat','batuk berdahak , flu , demam , mengencerkan dahak','obat batuk berdahak',NULL,NULL,NULL),(3,'ASAM MEFENAMAT BERNO 500MG',413,100,'obat','sakit gigi , sakit kepala , dismenore , nyeri , nyeri otot , generik','merupakan kelompok anti inflamasi nonsteroid yang mempunyai efek analgesik, anti inflamasi dan antipiretik.',NULL,NULL,NULL),(4,'VITAMIN C IPI',4200,120,'suplemen_vitamin','vitamin C , vitamin , suplemen , daya tahan tubuh , kekebalan tubuh','vitamin C untuk meningkatkan daya tahan tubuh',NULL,NULL,NULL),(5,'HEPAMAX CAP',335966,10,'suplemen_vitamin','suplemen hati , hepatitis , fungsi hati , liver , sakit kuning','suplemen pemelihara fungsi hati',NULL,NULL,NULL),(6,'PYNOCARE CAP 30S',128876,10,'suplemen_vitamin','suplemen , vitamin kulit , vitamin e , flek hitam','suplemen untuk kesehatan kulit',NULL,NULL,NULL),(7,'NESCO CHECK GLUCOSE STRIP 25\'S',4975,20,'alat_kesehatan','gula darah , tes kadar gula , test glucose','Nesco Glucose Strip merupakan alat kesehatan dengan fungsi mengukur kadar gula, sangat mudah dan praktis untuk digunakan.',NULL,NULL,NULL),(8,'TERUMO INFUSET DEWASA',23091,30,'alat_kesehatan','infuset , selang infus , alat infus , alat kesehatan','Terumo infuset dewasa merupakan alat kesehatan yang digunakan untuk keperluan infus pada pasien dewasa. Terumo infuset dewasa steril, non pyrogenic, tidak mengandung DEHP, dan tidak mengandung LATEX sehingga aman untuk digunakan. Segera digunakan setelah kemasan dibuka untuk menghindari risiko terjadinya infeksi. Digunakan untuk sekali pemakaian.',NULL,NULL,NULL),(9,'NEUROLOGICAL REFLEX HAMMERS GENERAL CARE',40529,15,'alat_kesehatan','reflex hammer , alkes , alat kesehatan , general care , neurological','Neurologiacal reflex hammer merupakan alat kesehatan yang digunakan untuk oleh praktisi kesehatan untuk memeriksa reflex tendon, refleks bagian terpenting dari sistem neurologic untuk mendeteksi adanya ketidak normalan pada sistem saraf pusat atau sitem saraf peripheral.',NULL,NULL,NULL);
...
-- Dump completed on 2017-12-11 19:01:43
